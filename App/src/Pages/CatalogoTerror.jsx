...
function CatalogoTerror(){
    ...
    let url = `https://api.themoviedb.org/3/discover/movie?api_key=${ApiKey}&with_genres=27&language=pt-BR&page=1`;
 useEffect(() => {
    ...
    return(
        <div>
            <div className="catalogo-geral">

          
            <h2 id="catalogo-geral-h2">Melhores Do Terror</h2>
