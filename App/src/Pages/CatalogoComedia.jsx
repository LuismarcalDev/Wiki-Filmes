...
function CatalogoComedia(){
    ...
    let url = `https://api.themoviedb.org/3/discover/movie?api_key=${ApiKey}&with_genres=35&language=pt-BR&page=1`;
 useEffect(() => {
    ...
    return(
        <div>
            <div className="catalogo-geral" id="comedia">

          
            <h2 id="catalogo-geral-h2">Pra Assistir com a Familia</h2>
...
export default CatalogoComedia