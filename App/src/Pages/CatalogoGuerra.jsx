...
function CatalogoGuerra(){
    ...
    let url = `https://api.themoviedb.org/3/discover/movie?api_key=${ApiKey}&with_genres=10752&language=pt-BR&page=1`;
 useEffect(() => {
    ...
    return(
        <div>
            ...
            <h2 id="catalogo-geral-h2">Guerra </h2>
