...
function CatalogoFantasia(){
    ...
    let url = `https://api.themoviedb.org/3/discover/movie?api_key=${ApiKey}&with_genres=14&language=pt-BR&page=1`;
 useEffect(() => {
    ...
    return(
        <div>
            <div className="catalogo-geral" id="fantasia" >

          
            <h2 id="catalogo-geral-h2">Que tal mergulhar Na Fantasia </h2>
...
export default CatalogoFantasia