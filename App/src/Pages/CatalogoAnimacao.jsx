...
function CatalogAnimacao(){
    ...
    let url = `https://api.themoviedb.org/3/discover/movie?api_key=${ApiKey}&with_genres=16&language=pt-BR&page=1`;
 useEffect(() => {
    ...
    return(
        <div>
            <div className="catalogo-geral" id="Animação" >

          
            <h2 id="catalogo-geral-h2">Animação </h2>
...
export default CatalogAnimacao