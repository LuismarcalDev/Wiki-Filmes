...
function CatalogoSobre(){
    ...
    const res = await fetch(`https://api.themoviedb.org/3/movie/${buscar}?api_key=${ApiKey}&language=pt-BR`);
...
let url = `https://api.themoviedb.org/3/movie/${buscar}/credits?api_key=11759f9ea83e1c27159572b9aaaa7a69&language=pt-BR`;
                ...
                <div className="container-filme-sobre">
                    ...
                    <div className="container-left-description">
                        <div className="info-sobre-filme">
                            ...
                            <h1>{filmeUnico.title} </h1>
                            <p className='comomns'><span>{filmeUnico?.release_date?.split("-")[0]}</span>| <img src={cont} alt="" /> | <span id='yellow'>Suspense</span> | <span>{filmeUnico.runtime}m</span></p>
