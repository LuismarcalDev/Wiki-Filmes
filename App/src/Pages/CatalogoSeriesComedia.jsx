...
function CatalogoSeriesComedia(){
    ...
    const ApiKey = "11759f9ea83e1c27159572b9aaaa7a69"
     const url = `https://api.themoviedb.org/3/discover/tv?api_key=${ApiKey}&language=pt-BR&with_genres=35&page=1`;
 ...
 useEffect(() => {
    ...
    return(
        <div>
            ...
            <h2 id="catalogo-geral-h2">Comedia Das Series </h2>
...
export default CatalogoSeriesComedia