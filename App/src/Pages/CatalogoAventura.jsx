...
function CatalogoAventura(){
    ...
    let url = `https://api.themoviedb.org/3/discover/movie?api_key=${ApiKey}&with_genres=12&language=pt-BR&page=1`;
 useEffect(() => {
    ...
    return(
        <div>
            <div className="catalogo-geral" id="Aventura" >

          
            <h2 id="catalogo-geral-h2"> Um pouco de Aventura</h2>
...
export default CatalogoAventura